...
import { ExerciseTableHead } from "../../workoutplan";
import { UserExerciseTableRow } from "./UserExerciseTableRow";
import { Workout } from "../../../models";

export const UserWorkoutTableRow = (props: { workout: Workout }) => {
                                ...
                                <TableBody>
                                    {
                                        workout.exercise.map((exercise, index) => {
                                            return (
                                                <UserExerciseTableRow key={index} exercise={exercise} />
                                            )
                                        })
                                    }
                                </TableBody>
